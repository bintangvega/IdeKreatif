...
<!-- Mengambil data kategori dari database -->
                ...
                ?>
                <tr>
<!-- Menampilkan nomor, nama kategory, dan opsi -->
                <td><? $index++; ?></td>
                <td><?= $category_name']; ?></td>
            <td>
<!-- Dropdown untuk opsi Edit dan Delete -->
            <div class="dropdown'>
                ...
                hide-arrow" data-bs-toggle="dropdown">
                    <i class="bx-dots-vertical-rounded"></i>
                </button>
                <div class="dropdown-menu">
                    <a href="#" class="dropdown-item" data-bs-toggle="modal"
                    data-bs-target="#editCategory_<?= $category['category_id']; ?>">
                        <i class="bx bx-edit-alt me-2"></i> Edit </a>
                    <a href="#" class="dropdpown-item" data-bs-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-titl">Hapus Kategori?</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"> </butoon>
        </div>
...
<!-- Modal untuk Update Data Kategory -->

    <div id="editCategory_<?= $category['category_id']; fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
